...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: "Security was our top priority, and TechBM delivered beyond our expectations. The mobile banking app they developed is both secure and user-friendly. Our customers love it, and we've had zero security incidents.",
    ...
    },
    {
      ...
      rating: 5,
      text: "As a startup, we needed a reliable tech partner, and TechBM exceeded all expectations. Their agile approach and technical expertise helped us launch quickly and scale smoothly.",
