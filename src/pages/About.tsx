...
const About = () => {
  ...
  const team = [
    { name: "Bazmi Mateen", role: "CEO & Founder", years: "2+ years experience" },
    { name: "mateen sahab", role: "CTO", years: "6+ years experience" },
    { name: "Aashif", role: "Lead Developer", years: "2+ years experience" },
    { name: "Abhishek", role: "Investor", },
  ];
